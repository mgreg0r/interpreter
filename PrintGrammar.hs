...
instance Print Stmt where
  prt i e = case e of
    ...
    ExpStmt expr -> prPrec i 0 (concatD [prt 0 expr])
    VarDecl type_ id -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString ";")])
    VarAsgn id expr -> prPrec i 0 (concatD [prt 0 id, doc (showString "="), prt 0 expr, doc (showString ";")])
    ...
    ArrayDecl type_ id exprs -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString "["), prt 0 exprs, doc (showString "]"), doc (showString ";")])
    ArrayAsgn id exprs expr -> prPrec i 0 (concatD [prt 0 id, doc (showString "["), prt 0 exprs, doc (showString "]"), doc (showString "="), prt 0 expr, doc (showString ";")])
...
instance Print Expr where
  prt i e = case e of
    ...
    EIndex id exprs -> prPrec i 6 (concatD [prt 0 id, doc (showString "["), prt 0 exprs, doc (showString "]")])
